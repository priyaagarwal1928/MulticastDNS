...
//  MultiCastSearch
//
//  Created by priya agarwal on 16/07/2020.
...
class JoinService: NSObject {
    ...
    func startBrowsing(netServiceBlock:  @escaping (String) -> Void, netServiceBrowserBlock: @escaping (String) -> Void, socketStatusBlock: @escaping (String, GCDAsyncSocket) -> Void, reloadConnectionsBlock: @escaping ([NetService]) -> Void) {
